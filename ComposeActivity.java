...
public class ComposeActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // reference to twitterClient.java
        client = TwitterApp.getRestClient(this);

        // reference to all the ui elements
        etComposed = findViewById(R.id.etCompose);
        ...
        btnTweet.setOnClickListener(new View.OnClickListener() {
            ...
            {
                // error handling -> Look up Android snap bar
                String tweetContent = etComposed.getText().toString();
                ...
                // Make an API call to twitter to publish the tweet -> POST
