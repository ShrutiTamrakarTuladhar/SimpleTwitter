...
- [x] User can **compose and post a new tweet**
  ...
  - [half] User can then enter a new tweet and post this to twitter
...
RestClient error, Json Http Response Handler error and github committing from android studio. 
...
## License
    ...
    Copyright [2019] [Shruti Tamrakar Tuladhar]
...
- [x]	User can **view tweets from their home timeline**
  ...
  - [half] User is displayed the [relative timestamp](https://gist.github.com/nesquena/f786232f5ef72f6e10a7) for each tweet "8m", "7h"
